  ...
  return (
    ...
    >
      <TouchableOpacity
        ...
        <LinearGradient
          colors={[feature.glow + '15', 'rgba(255,255,255,0.01)']}
          style={styles.cardGradient}>
          <LinearGradient colors={feature.gradient} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.accentLine} />
          <View style={styles.cardContent}>
            <View style={[styles.iconCircle, { backgroundColor: feature.glow + '20', borderColor: feature.glow + '60' }]}>
              <Icon name={feature.icon} size={24} color={feature.glow} />
            </View>
        ...
        <Animated.View entering={FadeInUp.duration(600).springify()}>
          <LinearGradient colors={[colors.bg.secondary, colors.bg.primary]} style={styles.hero}>
            <View style={[styles.logoRow, { justifyContent: 'center' }]}>
              ...
              <Text style={{fontSize: 32, fontWeight: typography.weights.bold, color: colors.text.primary, marginBottom: 4}}>NanoImage</Text>
            </View>
